...
namespace DotNetStandardSpotifyWebApi {
    ...
    public static class AuthorizationCodeFlow {
        ...
        public static async Task<SpotifyOAuthCredentials> GetSpotifyTokenCredentials(string OAuthToken, string clientId, string clientSecret, string redirectUri){
        ...
        public static async Task<SpotifyOAuthCredentials> RefreshAccessToken(SpotifyOAuthCredentials Credentials, string clientId, string clientSecret){
            return await RefreshAccessToken(Credentials.refresh_token, clientId, clientSecret);
        }

        public static async Task<SpotifyOAuthCredentials> RefreshAccessToken(string refreshToken, string clientId, string clientSecret){
        ...
        private static async Task<SpotifyOAuthCredentials> GetSpotifyCredentials(string PostBody, string clientId, string clientSecret, string refreshToken = null){
            ...
            SpotifyOAuthCredentials credentials = new SpotifyOAuthCredentials();
            if(response.IsSuccessStatusCode){
                ...
                credentials = new SpotifyOAuthCredentials("unknown user", accessToken, expiresIn, refreshToken);
            }
            return credentials;                      
        }
        #endregion
